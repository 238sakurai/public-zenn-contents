...
topics: ["API", "slack", "slackワークフロー", "Twitter", "X"]
published: false
...
![Slackの「X投稿ドラフト作成」モーダル。投稿内容・リプライ先・予約投稿日時・画像（最大4枚）を入力できる。](/images/articles/dresscode-2026-07-02_adventcalendar/x-post-draft-modal.gif)
...
最後にひとこと。企業の公式 SNS を運用されている方の参考になれば幸いです。実装の詳細や引き継ぎのことなど、お気軽にDM ください。